...
1. Lpr: 此函式為LLR的實現方法，其帶寬可由CV\_Partition函式決定。  
    ...
    * 參數輸入:
        ...
        * ker\_fun : 字串，預設為'Epan'。LLR估計時選用的核函數，僅提供Epanechnikov及高斯核函數。
            * 'Epan': Epanechnikov核函數，<a><img src="https://latex.codecogs.com/gif.latex?\inline&space;$K(x)&space;=&space;{\footnotesize&space;\cfrac{3}{4}}(1&space;-&space;x^2)&space;,&space;\;&space;|x|&space;\leq&space;1$" title="$K(x) = {\footnotesize \cfrac{3}{4}}(1 - x^2) , \; |x| \leq 1$" /></a>，其餘為0，
